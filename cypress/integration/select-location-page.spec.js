...
describe('select provice, city and office page functions', () => {
  ...
  it('should click into the Select a City dropdown and show city and locations and button ', () => {
    ...
    cy.get('#4802-href > :nth-child(2)').should(
      'have.text',
      ' ServiceCanada.gc.ca',
    )
    checkA11y(cy)
  ...
  it('should find British Columbia and the cities in the dropdown', () => {
    ...
    cy.get('#5001').click()
    cy.get('input[name="OfficeList"]').should('be.enabled')
    cy.get('#5001-href > :nth-child(2)').should(
      'have.text',
      ' ServiceCanada.gc.ca',
    )
  })
  ...
  it('should find Alberta and the cities in the dropdown', () => {
    ...
    cy.get('#4600').click()
    cy.get('input[name="OfficeList"]').should('be.enabled')
    cy.get('#4600-href > :nth-child(2)').should(
      'have.text',
      ' ServiceCanada.gc.ca',
    )
  })
  ...
  it('should find Ontario and the cities in the dropdown', () => {
    ...
    cy.get('#3006').click()
    cy.get('input[name="OfficeList"]').should('be.enabled')
    cy.get('#3006-href > :nth-child(2)').should(
      'contain.text',
      ' ServiceCanada.gc.ca',
    )
